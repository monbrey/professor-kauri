...
//   public async exec(interaction: any): Promise<void> {
//     const name = interaction.data.name;
//     const command = this.client.commandHandler.findCommand(name) as KauriCommand;

//     if (command?.interact) {
//       const channel =
//         this.client.channels.cache.get(interaction.channel_id) ||
//         new DMChannel(this.client, { id: interaction.channel_id });
//       if (!channel?.isText()) return;

//       const message = new KauriMessage(
//         this.client as KauriClient,
