// import type { AutocompleteInteraction, CommandInteraction, CommandInteractionOption } from "discord.js";
...
// 		const choices = list.filter((x) => x.rating >= 0.5).map((x) => ({
// 			name: x.target,
// 			value: x.target,
// 		}));
...
// 		let attacker; let defender;
// 		if (args["by-species"]) {
// 			const _args = args["by-species"];
// 			attacker = {
// 				name: _args.attacker.name,
// 				value: _args.attacker.speed,
// 			};
// 			defender = {
// 				name: _args.defender.name,
// 				value: _args.defender.speed,
// 			};
// 		} else if (args["by-number"]) {
// 			const _args = args["by-number"];
// 			attacker = {
// 				name: `${_args.attacker}`,
// 				value: _args.attacker,
// 			};
// 			defender = {
// 				name: `${_args.defender}`,
// 				value: _args.defender,
// 			};
// 		} else {
// 			return;
// 		}
...
// 				{
// 					name: "Electro Ball",
// 					value: `${this.calcElectro(attacker.value, defender.value)} BP`,
// 					inline: true,
// 				},
// 				{
// 					name: "Gyro Ball",
// 					value: `${this.calcGyro(attacker.value, defender.value)} BP`,
// 					inline: true,
// 				},
// 			]);
