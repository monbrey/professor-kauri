...
// 				name: species.attacker.name,
// 				value: species.attacker.weight,
// 			};
// 			defender = {
// 				name: species.defender.name,
// 				value: species.defender.weight,
// 			};
// 		} else if (number) {
// 			attacker = number.attacker && {
// 				name: `${number.attacker}`,
// 				value: number.attacker,
// 			};
// 			defender = {
// 				name: `${number.defender}`,
// 				value: number.defender,
// 			};
// 		} else {
// 			return;
// 		}
...
// 						value: `${this.calcTwo(attacker.value, defender.value)} BP`,
// 						inline: true,
// 					},
// 					{
// 						name: "Grass Knot / Low Kick",
// 						value: `${this.calcOne(attacker.value)} BP`,
// 						inline: true,
// 					},
// 				],
// 			};
...
// 					{
// 						name: "**Grass Knot / Low Kick**",
// 						value: `${this.calcOne(defender.value)} BP`,
// 						inline: true,
// 					},
// 				],
// 			};
