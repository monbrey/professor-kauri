...
// import type { Rating } from "string-similarity";
...
// 		for (const m of this.mega) {
// 			m.type2 = m.type2 !== "NONE" ? m.type2 : undefined;
// 		}
...
// 		if (this.maleAllowed && this.femaleAllowed) {
// 			return ["Male", "Female"];
// 		}
...
// 			return [
// 				`Pokemart: ${this.pokemart.toLocaleString("en-US", {
// 					style: "currency",
// 					currency: "USD",
// 				})}`,
// 				`Berry Store: ${this.berryStore.toLocaleString("en-US", {
// 					style: "currency",
// 					currency: "USD",
// 				})}`,
// 			];
...
// 		return this.attacks.reduce<string[]>((acc, val) => val.method === method ? [...acc, val.name] : acc, []);
// 	}

// 	public get icon(): string {
// 		const variant = this.name.includes("-") ? `${this.name.slice(this.name.indexOf("-"))}` : "";
...
// 		if (this.attacks.find((a) => a.method === "LEVEL-UP")) {
// 			learnset["By Level"] = this.attacksByMethod("LEVEL-UP");
// 		}

// 		if (this.attacks.find((a) => a.method === "TM")) {
// 			learnset["By TM"] = this.attacksByMethod("TM");
// 		}

// 		if (this.attacks.find((a) => a.method === "HM")) {
// 			learnset["By HM"] = this.attacksByMethod("HM");
// 		}

// 		if (this.attacks.find((a) => a.method === "BREEDING")) {
// 			learnset["By BM"] = this.attacksByMethod("BREEDING");
// 		}

// 		if (this.attacks.find((a) => a.method === "MOVE TUTOR")) {
// 			learnset["By MT"] = this.attacksByMethod("MOVE TUTOR");
// 		}

// 		if (this.attacks.find((a) => a.method === "SPECIAL")) {
// 			learnset["By SM"] = this.attacksByMethod("SPECIAL");
// 		}
