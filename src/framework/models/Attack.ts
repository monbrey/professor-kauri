...
// 		const data = await database.collection("attack").aggregate<AttackSchema>([{ $match: { metronome: true } }, { $sample: { size: 1 } }]).toArray();
// 		if (!data) {
...
// 			embed.addField("**Helpful data**", this.list.join("\n"));
// 		}
...
// 		if (this.zmove) {
// 			embed.addField("**Z-Move**", this.zmove);
// 		}

// 		if (this.maxmove) {
// 			embed.addField("**Dynamax Move**", this.maxmove);
// 		}
